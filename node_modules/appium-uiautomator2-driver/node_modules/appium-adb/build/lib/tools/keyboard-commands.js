...
exports.isSoftKeyboardPresent = isSoftKeyboardPresent;
exports.keyevent = keyevent;
exports.availableIMEs = availableIMEs;
exports.enabledIMEs = enabledIMEs;
exports.enableIME = enableIME;
exports.disableIME = disableIME;
exports.setIME = setIME;
exports.defaultIME = defaultIME;
exports.inputText = inputText;
exports.runInImeContext = runInImeContext;
...
async function runInImeContext(ime, fn) {
    ...
    if (originalIme === ime) {
        logger_js_1.log.debug(`The original IME is the same as '${ime}'. There is no need to reset it`);
    }
    else {
...
//# sourceMappingURL=keyboard-commands.js.map