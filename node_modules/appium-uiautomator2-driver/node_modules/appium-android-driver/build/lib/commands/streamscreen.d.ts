 ...
 */
export function mobileStartScreenStreaming(this: import("../driver").AndroidDriver, options?: import("./types").StartScreenStreamingOpts): Promise<void>;
export class mobileStartScreenStreaming {
     ...
     * @returns {Promise<void>}
     */
    constructor(this: import("../driver").AndroidDriver, options?: import("./types").StartScreenStreamingOpts);
