 ...
 */
export function mobileSetConnectivity(this: import("../driver").AndroidDriver, opts?: import("./types").SetConnectivityOpts): Promise<void>;
/**
 * @this {import('../driver').AndroidDriver}
 * @param {import('./types').GetConnectivityOpts} [opts={}]
 * @returns {Promise<import('./types').GetConnectivityResult>}
 */
export function mobileGetConnectivity(this: import("../driver").AndroidDriver, opts?: import("./types").GetConnectivityOpts): Promise<import("./types").GetConnectivityResult>;
/**
 * @since Android 12 (only real devices, emulators work in all APIs)
 * @this {import('../driver').AndroidDriver}
 * @param {number} type
