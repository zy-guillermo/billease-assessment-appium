 ...
 */
export function getDeviceTime(this: import("../driver").AndroidDriver, format?: string): Promise<string>;
/**
 * @this {AndroidDriver}
 * @param {import('./types').DeviceTimeOpts} [opts={}]
 * @returns {Promise<string>}
 */
export function mobileGetDeviceTime(this: import("../driver").AndroidDriver, opts?: import("./types").DeviceTimeOpts): Promise<string>;
/**
 * @this {AndroidDriver}
